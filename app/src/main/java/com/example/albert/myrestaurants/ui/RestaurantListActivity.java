...
public class RestaurantListActivity extends AppCompatActivity implements OnRestaurantSelectedListener {
        ...
        if (savedInstanceState != null) {
            if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                if (mPosition != null && mRestaurants != null) {
                    ...
                    intent.putExtra(Constants.EXTRA_KEY_RESTAURANTS, mRestaurants);
    ...
    @Override
    public void onRestaurantSelectedListener(Integer position, ArrayList<Restaurant> restaurants) {
        mPosition = position;
